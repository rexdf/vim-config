...
map <silent> <leader>b :cexpr system("bundle exec ~/scm/utils/bin/brakeman2err")<CR>
map <silent> <leader>B :cexpr system("bundle exec ~/scm/utils/bin/brakeman2err -c")<CR>
